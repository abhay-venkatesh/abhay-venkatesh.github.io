...
Abhay Venkatesh is a Software Engineer at [Anduril Industries](https://anduril.com/) focusing on Platform Infrastructure Product and Software Architecture.
...
Abhay is primarily interested in Software Systems and Software Platform Infrastructure. He has successfully designed and built ground-breaking robotics platforms as well invented cutting-edge AI algorithms. Abhay believes the next-generation of Software Systems will be defined by Artificial General Intelligence (AGI) in the limit case, increasingly general learning systems in the short term on the Centralization side, and Privacy, Security and Crypto on the Decentralization side.
